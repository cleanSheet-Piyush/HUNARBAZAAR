...
import officialCertAsset from "../assets/official_hunarbazaar_certificate.png";
...
const OrderCertificateCard = ({ order, user }) => {
  ...
  const handleDownload = () => {
    ...
    const certHtml = `
      ...
      <html>
        <head>
          <title>HUNARBAZAAR Official Certificate - ${order.product_title || "Artisan Craft"}</title>
          <style>
      ...
      <div className="occ-header-bar">
        <div className="occ-title-group">
          ...
          <div>
            ...
            <p>Issued by HUNARBAZAAR (Team ArticianX) for purchasing genuine handcrafted art</p>
          </div>
        </div>
      ...
      {canShowAndDownload ? (
        ...
        >
          ...
          <p style={{ margin: "0 auto", maxWidth: 480, fontSize: 13, color: "#d6d3d1", lineHeight: 1.5 }}>
            Your official <strong>HUNARBAZAAR Digital Authenticity Certificate</strong> will appear and become downloadable right here once the artisan dispatches your package and updates order status to <strong>SHIPPED</strong>.
          </p>
          <div
            style={{
              marginTop: 14,
