  ...
  return (
    <div className="voice-panel-page">
      ...
      <div className="regalia-hero-banner">
        <h1>{isHi ? "कारीगर स्टूडियो और प्रदर्शनी" : "ARTISAN STUDIO & EXHIBITION"}</h1>
        <div className="regalia-breadcrumb">
          {isHi ? "होम" : "Home"} <span>/</span> {isHi ? "कारीगर वर्कस्पेस" : "Artisan Workspace"} <span>/</span> {isHi ? "AI कैटलॉगिंग और ऑर्डर" : "AI Cataloging & Orders"}
        </div>
      </div>
      ...
      <div className="regalia-container">
        ...
        <div className="workspace-card" style={{ marginBottom: 20 }}>
          <div className="card-top">
            ...
            <div>
              <h3>{isHi ? "ट्रस्ट बैज" : "Trust Badge"}</h3>
              <p>{isHi ? "अपना खाता एक बार सत्यापित करें ताकि खरीदारों को आपकी लिस्टिंग पर \"✓ सत्यापित\" बैज दिखे — कोई औपचारिक दस्तावेज़ आवश्यक नहीं।" : "Verify your account once so buyers see a \"✓ Verified\" badge on your listings — no formal documents required."}</p>
            </div>
          </div>
          ...
          {user?.is_verified ? (
            ...
            >
              ...
              <div>
                <strong style={{ color: "#2f6f4f" }}>{isHi ? "आप एक सत्यापित कारीगर हैं" : "You're a verified artisan"}</strong>
                <p style={{ margin: "2px 0 0", fontSize: 12, color: "#4a6e5a" }}>
                  {isHi ? "यह बैज अब आपकी सभी लिस्टिंग पर दिखाई देता है।" : "This badge is now visible on all your listings."}
                </p>
              </div>
            </div>
          ) : verifLoading ? (
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
                ...
                <div style={{ flex: "1 1 260px", display: "flex", flexDirection: "column", gap: 10 }}>
                  <input
                    type="text"
                    placeholder={isHi ? "संदर्भ का नाम (क्लस्टर समन्वयक, NGO संपर्क, या सत्यापित कारीगर)" : "Reference name (a cluster coordinator, NGO contact, or fellow verified artisan)"}
                  ...
                  <input
                    type="text"
                    placeholder={isHi ? "संदर्भ फोन (वैकल्पिक)" : "Reference phone (optional)"}
                  ...
                  <input
                    type="text"
                    placeholder={isHi ? "आप उन्हें कैसे जानते हैं? (वैकल्पिक)" : "How do you know them? (optional)"}
              ...
              >
                ...
                {verifSubmitting ? (isHi ? "जमा हो रहा है..." : "Submitting...") : (isHi ? "सत्यापन के लिए जमा करें" : "Submit for verification")}
              </button>
            </div>
          )}
        </div>
        ...
        <div className="workspace-card" style={{ marginTop: 20 }}>
          <div className="card-top">
            ...
            <div>
              <h3>{isHi ? "वॉयस कैटलॉगिंग और खोज" : "Voice Cataloging & Search"}</h3>
              <p>{isHi ? "अपनी कला को हिंदी या अंग्रेजी में ज़ोर से बताएं। हम इसे लिखेंगे, विवरण पहचानेंगे और आपकी लिस्टिंग स्वचालित रूप से तैयार करेंगे।" : "Describe your craft out loud in Hindi or English. We'll transcribe it, detect details, and draft your listing automatically."}</p>
            </div>
          </div>
          ...
          {!audioDataUrl && (
            <div className="record-area">
              ...
              <div className="record-status">
                <strong>{isRecording ? (isHi ? "रिकॉर्डिंग जारी है... रोकने के लिए टैप करें" : "Recording in progress... Tap to stop") : (isHi ? "बोलना शुरू करने के लिए माइक्रोफोन टैप करें" : "Tap microphone to start speaking")}</strong>
                <span>
                  {isRecording
                    ? (isHi ? "अपनी कला के बारे में स्पष्ट रूप से बोलें — सामग्री, रंग, तकनीक और सुझाया गया मूल्य।" : "Speak clearly about your craft — material, color, technique, and suggested price.")
                    : (isHi ? "हिंदी, अंग्रेजी या अपनी स्थानीय भाषा में ज़ोर से बताएं।" : "Describe the piece out loud in Hindi, English, or your local regional dialect.")}
                </span>
              </div>
        ...
        <div className="workspace-card" style={{ marginTop: 20 }}>
          <div className="card-top">
            ...
            <div>
              <h3>{isHi ? "प्राप्त ऑर्डर" : "Orders Received"}</h3>
              <p>{isHi ? "खरीदारों द्वारा आपकी लिस्टिंग पर दिए गए ऑर्डर।" : "Orders buyers have placed on your published listings."}</p>
            </div>
          </div>

          {ordersLoading && <p>{isHi ? "ऑर्डर लोड हो रहे हैं..." : "Loading orders..."}</p>}
          ...
          {!ordersLoading && !ordersError && orders.length === 0 && (
            <p className="empty-state">{isHi ? "अभी तक कोई ऑर्डर नहीं। जब कोई खरीदार आपकी लिस्टिंग से ऑर्डर करेगा, तो वह यहाँ दिखेगा।" : "No orders yet. Once a buyer orders one of your listings, it'll show up here."}</p>
          )}
