...
def pricing(request):
    ...
    grounded in comparable listings already published on HUNARBAZAAR,
...
@permission_classes([AllowAny])
def chatbot(request):
    """24/7 AI Chatbot Assistant for HUNARBAZAAR Artisan Marketplace.
    ...
    prompt = f"""You are HUNARBAZAAR AI, an empathetic, highly knowledgeable assistant for HUNARBAZAAR — an artisan marketplace directly connecting marginalized Indian craftspeople with buyers.
...
- Respond in plain text only, no markdown symbols like ** or ##."""
    ...
    if any(k in q for k in ["hi", "hello", "hlw", "hey", "namaste", "hlo", "नमस्ते", "हेलो", "नमस्कार", "हलो"]):
        reply = (
            ...
            if is_hi else
            "Namaste! Welcome to HUNARBAZAAR 24/7 AI Support. You can ask me about order tracking, refunds & returns, shipping timeline, 0% platform fee, or artisan voice onboarding!"
        )
    ...
    # Contact & Helpline
        ...
        reply = (
            "📞 24/7 सहायता हेल्पलाइन: आप हमारे हेल्पलाइन नंबर +91 6207443800 पर कॉल कर सकते हैं या support@hunarbazaar.com पर ईमेल भेज सकते हैं।"
            if is_hi else
            "📞 24/7 Support Helpline: Call us directly at +91 6207443800 or email support@hunarbazaar.com for immediate assistance."
        )
    ...
    # Bot Identity & Name Queries
        ...
        reply = (
            "मैं कारीगर 24/7 AI सहायक (HUNARBAZAAR AI) हूँ! मैं भारतीय कारीगरों और खरीदारों की सहायता के लिए बनाया गया AI असिस्टेंट हूँ। मैं ऑर्डर ट्रैकिंग, शिपिंग, रिफ़ंड और कारीगर वॉयस लिस्टिंग में आपकी मदद कर सकता हूँ।"
            if is_hi else
            "I am the HUNARBAZAAR 24/7 AI Assistant! I am an intelligent AI helper built for the HUNARBAZAAR Artisan Marketplace to assist buyers with orders, shipping & returns, and help Indian master artisans sell crafts."
        )
    ...
    # Dynamic Natural Conversational Fallback for General Queries
        ...
        reply = (
            f"मैं कारीगर 24/7 AI सहायक हूँ। आपके प्रश्न '{query}' के बारे में — आप मुझसे ऑर्डर ट्रैकिंग, रिफंड, डिलीवरी या कारीगर वॉयस रजिस्ट्रेशन के बारे में पूछ सकते हैं, या हेल्पलाइन +91 6207443800 पर संपर्क कर सकते हैं!"
            if is_hi else
            f"I am the HUNARBAZAAR 24/7 AI Assistant. Regarding '{query}' — You can ask me about order tracking, 7-day refunds, shipping status, or artisan onboarding, or call our 24/7 helpline at +91 6207443800!"
        )
