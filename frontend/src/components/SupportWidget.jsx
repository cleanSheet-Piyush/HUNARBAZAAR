...
const SupportWidget = () => {
  ...
  const [messages, setMessages] = useState([
    {
      ...
      text: language === "hi"
        ...
        : "Namaste! I am your 24/7 HUNARBAZAAR AI Assistant. How can I help you today with orders, artisans, or shipping?",
  ...
  const handleSend = async (textToSend) => {
    ...
    try {
      let botReply;
      try {
        botReply = await askGemini(query, language === "hi" ? "hi" : "en", user?.role || "buyer", controller.signal);
      } catch (geminiErr) {
        if (geminiErr.name === "AbortError") {
          botReply = language === "hi"
            ? "माफ़ कीजिये, AI का जवाब आने में देरी हो रही है। कृपया दोबारा पूछें या हेल्पलाइन +91 6207443800 पर कॉल करें।"
            : "Sorry, the AI is taking too long. Please try again or call our helpline at +91 6207443800.";
        } else {
          try {
            ...
            botReply = response.data?.reply || (
              language === "hi"
                ? "धन्यवाद! हेल्पलाइन: +91 6207443800"
                : "Thank you! Helpline: +91 6207443800"
            );
          } catch {
            botReply = language === "hi"
              ? "माफ़ कीजिये, नेटवर्क समस्या है। हेल्पलाइन +91 6207443800 पर कॉल करें।"
              : "Sorry, network issue. Please call +91 6207443800 for immediate help.";
          }
        }
      }
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          sender: "bot",
          text: language === "hi"
            ? "माफ़ कीजिये, कुछ गड़बड़ हो गई। हेल्पलाइन: +91 6207443800"
            : "Sorry, something went wrong. Helpline: +91 6207443800",
          time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
        }
      ]);
    } finally {
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div>
                <h4 style={{ margin: 0, fontSize: 14, color: "#ffffff" }}>
                  {language === "hi" ? "कारीगर 24/7 AI सहायता" : "HUNARBAZAAR 24/7 AI Support"}
                </h4>
                <span style={{ fontSize: 10, color: "#86efac", display: "flex", alignItems: "center", gap: 4 }}>
                  <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#22c55e" }} />
                  {language === "hi" ? "ऑनलाइन • Gemini AI द्वारा संचालित" : "Online • Powered by Gemini AI"}
                </span>
              </div>
            </div>
