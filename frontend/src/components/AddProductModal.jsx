...
const AddProductModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const existing = JSON.parse(localStorage.getItem("hunarbazaar_custom_products") || "[]");
      localStorage.setItem("hunarbazaar_custom_products", JSON.stringify([payload, ...existing]));
      window.dispatchEvent(new CustomEvent("hunarbazaar_product_added", { detail: payload }));
    } catch (localErr) {
